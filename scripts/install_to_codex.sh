...
mkdir -p \
  ...
  "$TARGET_DIR/perplexity-fetch-url-content"
...
cp -R "$ROOT_DIR/perplexity-fetch-url-content/." "$TARGET_DIR/perplexity-fetch-url-content/"
cp "$ROOT_DIR/perplexity_common.py" "$TARGET_DIR/perplexity_search_only/"
cp "$ROOT_DIR/perplexity_common.py" "$TARGET_DIR/perplexity-pro-search/"
cp "$ROOT_DIR/perplexity_common.py" "$TARGET_DIR/perplexity-fetch-url-content/"

echo "Installed:"
echo "  - $TARGET_DIR/perplexity_search_only"
echo "  - $TARGET_DIR/perplexity_deep_research"
echo "  - $TARGET_DIR/perplexity-pro-search"
echo "  - $TARGET_DIR/perplexity-fetch-url-content"
